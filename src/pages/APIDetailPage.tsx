...
import { ArrowLeft, Clock, Target, Code, BookOpen, Play, Copy, Check, ExternalLink, Shield, Zap, Globe } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-gray-600 mb-8">The requested API could not be found.</p>
          <Link to={`/apis/${category}`} className="text-red-600 hover:text-red-700">
      ...
      <div className="bg-gray-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <Link to={`/apis/${category}`} className="text-gray-500 hover:text-red-600 transition-colors capitalize">{category}</Link>
            <span className="text-gray-400">/</span>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="text-center">
                  ...
                  <div className="text-xl font-bold">{apiData.responseTime}</div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            {/* Features */}
            <section>
              <h2 className="font-gilroy text-2xl font-bold text-gray-900 mb-6">Key Features</h2>
            ...
            {/* Use Cases */}
            <section>
              <h2 className="font-gilroy text-2xl font-bold text-gray-900 mb-6">Use Cases</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {apiData.useCases.map((useCase, index) => (
                  <div key={index} className="p-6 border border-gray-200 rounded-lg hover:border-red-200 hover:shadow-md transition-all">
                    <h3 className="font-semibold text-gray-900 mb-2">{useCase}</h3>
                    <p className="text-sm text-gray-600">Perfect for businesses requiring secure identity verification</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            {/* Code Examples */}
            <section>
              <h2 className="font-gilroy text-2xl font-bold text-gray-900 mb-6">Code Examples</h2>
              <div className="bg-gray-900 rounded-lg overflow-hidden">
                ...
                <div className="relative">
                  <pre className="p-6 text-sm text-gray-300 overflow-x-auto">
                    <code>{apiData.codeExamples[activeTab as keyof typeof apiData.codeExamples]}</code>
                  </pre>
                  <button
                    onClick={() => copyToClipboard(apiData.codeExamples[activeTab as keyof typeof apiData.codeExamples], activeTab)}
            ...
            {/* API Endpoints */}
            <section>
              <h2 className="font-gilroy text-2xl font-bold text-gray-900 mb-6">API Endpoints</h2>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-lg p-6 border border-red-200">
              <h3 className="font-gilroy text-lg font-bold text-gray-900 mb-4">Quick Start</h3>
              <div className="space-y-4">
                <button 
                  onClick={() => openSignUpModal('trial')}
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <h3 className="font-gilroy text-lg font-bold text-gray-900 mb-4">Pricing</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Per verification</span>
                  <span className="font-bold text-gray-900">{apiData.pricing}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Free tier</span>
                  <span className="font-bold text-green-600">1,000 calls/month</span>
                </div>
            ...
            {/* Support */}
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <h3 className="font-gilroy text-lg font-bold text-gray-900 mb-4">Need Help?</h3>
              <div className="space-y-3">
