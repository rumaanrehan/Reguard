...
import { ArrowLeft, Play, BookOpen, ExternalLink, Sparkles, Shield, Clock, Users, CheckCircle, Star, Gavel, AlertTriangle, TrendingUp } from 'lucide-react';
...
export const SolutionDetailPage: React.FC = () => {
  ...
  const solutionsData = {
    'embedkyc': {
      ...
      badge: 'NEW',
      description: 'Build and customize your own KYC compliance workflows with our intuitive drag-and-drop interface. Create tailored identity verification processes that match your exact regulatory requirements and business needs.',
    ...
    'watchdawg': {
      ...
      description: 'Comprehensive AML risk monitoring solution that provides continuous surveillance across all customer touchpoints to identify and mitigate financial crimes before they impact your institution.',
    ...
    'complianceiq': {
      ...
      longDescription: 'ComplianceIQ revolutionizes regulatory compliance management through intelligent automation, real-time monitoring, and predictive analytics. Our platform helps organizations navigate complex regulatory landscapes while reducing costs and ensuring continuous compliance across multiple frameworks.',
      icon: Gavel,
    ...
    'fraudshield': {
      ...
      longDescription: 'FraudShield leverages advanced machine learning algorithms, behavioral analytics, and real-time data processing to detect and prevent fraud across all channels. Our platform adapts to emerging fraud patterns and provides comprehensive protection for financial institutions and businesses.',
      icon: AlertTriangle,
    ...
    'riskradar': {
      ...
      longDescription: 'RiskRadar transforms risk management through intelligent automation, predictive analytics, and real-time monitoring. Our platform provides comprehensive risk visibility, automated assessment, and proactive mitigation strategies to protect your organization from emerging threats.',
      icon: TrendingUp,
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gray-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <Link to="/solutions" className="text-gray-500 hover:text-red-600 transition-colors">Solutions</Link>
            <span className="text-gray-400">/</span>
      ...
      {/* Hero Section */}
      <section className={`bg-gradient-to-br ${solution.gradient} text-white py-20`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {solution.features.map((feature, index) => (
                  <div key={index} className="flex items-start space-x-4 p-6 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                    <div className={`w-3 h-3 rounded-full bg-gradient-to-r ${solution.gradient} mt-2 flex-shrink-0`}></div>
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-1">{feature}</h3>
                      <p className="text-sm text-gray-600">Advanced capability designed for enterprise needs</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {solution.benefits.map((benefit, index) => (
                  <div key={index} className="flex items-start space-x-4 p-6 border border-gray-200 rounded-xl hover:border-gray-300 hover:shadow-md transition-all">
                    <CheckCircle size={24} className={`${solution.iconColor} mt-1 flex-shrink-0`} />
                    <div>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {solution.useCases.map((useCase, index) => (
                  <div key={index} className={`p-6 rounded-xl bg-gradient-to-br ${solution.bgGradient} border border-gray-200 hover:shadow-lg transition-all`}>
                    <div className="flex items-center space-x-3 mb-3">
                      <div className={`w-10 h-10 ${solution.iconBg} rounded-lg flex items-center justify-center`}>
                        <Star size={16} className={solution.iconColor} />
                      </div>
                      <h3 className="font-semibold text-gray-900">{useCase}</h3>
                    </div>
                    <p className="text-sm text-gray-600">Streamline processes and ensure compliance in this critical area</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            <section className="bg-white border border-gray-200 rounded-2xl p-8">
              ...
              <blockquote className="text-lg text-gray-700 italic mb-4">
                "{solution.name} has transformed how we handle identity verification. The customization options and ease of use have improved our conversion rates significantly while maintaining the highest security standards."
              </blockquote>
          ...
          <div className="space-y-8">
            {/* Quick Start */}
            <div className={`bg-gradient-to-br ${solution.bgGradient} rounded-xl p-6 border border-gray-200`}>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              <h3 className="font-gilroy text-xl font-bold text-gray-900 mb-6">Pricing Plans</h3>
              <div className="space-y-4">
                <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
                  ...
                  <span className="font-bold text-gray-900">{solution.pricing.starter}</span>
                </div>
                <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
                  <div>
                  ...
                  <span className="font-bold text-gray-900">{solution.pricing.professional}</span>
                </div>
                <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
                  <div>
                  ...
                  <span className="font-bold text-gray-900">{solution.pricing.enterprise}</span>
                </div>
              </div>
            </div>
            ...
            {/* Support */}
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              <h3 className="font-gilroy text-xl font-bold text-gray-900 mb-6">Need Help?</h3>
              <div className="space-y-4">
